    ...
    <header className="mb-2">
      <div className="navbar flex justify-between bg-slate-700 border-r-2">
        ...
        <div className="flex justify-end">
          <a href="/resume.pdf" download className="h-11 w-11 mx-1 bg-transparent hover:border-b-2 hover:border-slate-400 transition duration-200">
            <img
              src="/resumeIcon.png"
              alt="resume icon"
          ...
          <a
            ...
            className="h-12 w-12 mx-1 bg-transparent hover:border-b-2 hover:border-slate-400 transition duration-200"
          >
            <img
